<script lang="ts">
  ...
  import CompressWorkspace from '../tools/organise/CompressWorkspace.svelte';
  import MergeWorkspace from '../tools/organise/MergeWorkspace.svelte';
  import RemoveWorkspace from '../tools/organise/RemoveWorkspace.svelte';
